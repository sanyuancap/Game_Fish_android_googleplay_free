...
public interface RecordListener {
	 ...
	 * implementation of this method retrieves the record, it will receive the
	 * changed version.
	 * 
	 * @param recordStore
	 *            the RecordStore in which the record is stored
	 * @param recordId
	 *            the recordId of the record that has been changed
	 */
	 ...
	 * implementation of this method tries to retrieve the record from the
	 * record store, an InvalidRecordIDException will be thrown.
	 * 
	 * @param recordStore
	 *            the RecordStore in which the record was stored
	 * @param recordId
	 *            the recordId of the record that has been deleted
	 */
